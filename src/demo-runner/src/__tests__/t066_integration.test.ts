 ...
 *
 * Run with: cd src/demo-runner && npx vitest run src/__tests__/sections.test.ts
 * Or standalone: npx vitest run tests/demo/t066_demo_runner_admin_integration.test.ts
 */
