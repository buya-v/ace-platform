...
const envSetup: Section = {
  ...
  steps: [
    ...
    {
      id: 'env-3',
      title: 'Check All Service Health',
      description: 'Verify health endpoints for all services (ports 8081-8088)',
      method: 'GET',
      url: '/healthz',
      validateResponse: okValidator,
    },
    {
      ...
      description: 'Verify gateway can route to backend services',
      method: 'GET',
  ...
  steps: [
    {
      ...
      method: 'GET',
      url: (state) => `/api/v1/compliance/participants/${state.trader1_id || 'trader1'}/status`,
      headers: (state) => authHeader(state, 'admin'),
      validateResponse: okValidator,
    },
    {
      ...
      method: 'GET',
      url: (state) => `/api/v1/compliance/participants/${state.trader1_id || 'trader1'}/risk-score`,
      headers: (state) => authHeader(state, 'admin'),
      validateResponse: okValidator,
    },
    {
